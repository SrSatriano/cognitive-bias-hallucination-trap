...
Obrigado por considerar uma contribuição para **Framework de armadilhas cognitivas e alucinação**.

## Como começar

1. Faça um fork do repositório [cognitive-bias-hallucination-trap](https://github.com/SrSatriano/cognitive-bias-hallucination-trap).
