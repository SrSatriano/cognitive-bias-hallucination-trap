...
# Framework de armadilhas cognitivas e alucinação

**Framework de armadilhas cognitivas e alucinação**

<p>
  <a href="https://github.com/SrSatriano/cognitive-bias-hallucination-trap"><img src="https://img.shields.io/badge/GitHub-cognitive-bias-hallucination-trap-24292e?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" /></a>
</p>
...
<p><strong>QA adversarial para LLMs locais antes de produção.</strong></p>
...
| | |
|---|---|
| **Problema** | LLMs em produção alucinam sob viés e perguntas adversariais. |
| **Solução** | Suite de traps categorizados com matriz de confusão exportável. |

## Para quem é

Equipes de AI safety e MLOps.

## Casos de uso

- Gate de release de modelo
- Comparar temperaturas

## Funcionalidades

- [x] 48 cenários de trap
- [x] Export JSON de resultados
- [x] Integração vLLM OpenAI-compatible
- [x] Relatório por categoria
- [x] Calibração de sampling

## Stack tecnológica

| Camada | Tecnologias |
|--------|-------------|
| **Principal** | Python, LangChain, vLLM |

## Arquitetura

```mermaid
flowchart LR
  TRAP[Suite de traps] --> LLM[vLLM local]
  LLM --> MAT[Matriz de confusão]
```
...
| Caminho | Descrição |
|---------|-----------|
| `src/run_suite.py` | Runner |
| `traps/` | Cenários YAML |

## Pré-requisitos

Python 3.11+, vLLM ou Ollama.

## Instalação e execução

```bash
git clone https://github.com/SrSatriano/cognitive-bias-hallucination-trap.git
cd cognitive-bias-hallucination-trap
```

```bash
python -m src.run_suite --model qwen2.5-7b
```
...
|----------|-----------|--------|
| `VLLM_BASE_URL` | API | `http://localhost:8000/v1` |
...
- Métricas automáticas não substituem revisão humana
...
<p align="center">Desenvolvido com foco em clareza e engenharia de produção · <a href="https://github.com/SrSatriano/cognitive-bias-hallucination-trap">Ver no GitHub</a></p>
