# Arquitetura — Framework de armadilhas cognitivas e alucinação

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

Suite de traps categorizados com matriz de confusão exportável.
...
|------------|------------------|
| 48 | 48 cenários de trap |
| Export | Export JSON de resultados |
| Integração | Integração vLLM OpenAI-compatible |
| Relatório | Relatório por categoria |
| Calibração | Calibração de sampling |
